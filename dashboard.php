    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.php
       " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">TPO management</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/tables.php">
            ...
            <span class="nav-link-text ms-1">Performance Analysis</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="../pages/decription.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/progress.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Progress T</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">More Information</h6>
        </li>
        <li class="nav-item">
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="d-flex flex-column h-100">
                    ...
                    <h5 class="font-weight-bolder">Sanjay Ghodawat University, kolhapur</h5>
    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Sanjay Ghodawat University</h5>
